...
static void cursor_position_callback(GLFWwindow* window, double xpos, double ypos)
{
    ...
    if (mode_i == TRUE)
    {
//        L[-1] = glm::vec2(p_world.x, p_world.y);
//        VBO.update(L);
    }
...
void mouse_button_callback(GLFWwindow* window, int button, int action, int mods)
{
    ...
    if (button == GLFW_MOUSE_BUTTON_LEFT && action == GLFW_PRESS)
    {
        if (mode_i == TRUE)
        {
            L.push_back(glm::vec2(xworld, yworld));
        }
        else
        {
...
//    switch (key)
//    {
//        case  GLFW_KEY_O && action == GLFW_PRESS:
//            cout << "some" << endl;
//            break;
//        case GLFW_KEY_2:
//            V[0] = glm::vec2(0,  0.5);
...
//    V.resize(5);
//    V.push_back(glm::vec2(0,  0.5));
//    V.push_back(glm::vec2(-0.5, -0.5));
//    V.push_back(glm::vec2(0.5, -0.5));
//
//
//    V[0] = glm::vec2(0,  0.5);
...
//    L.resize(8);
//    L[0] = glm::vec2(0.5,  0.2);
//    L[1] = glm::vec2(-0.6,  0.8);
//    L[2] = glm::vec2(-0.8,  0.3);
//    L[3] = glm::vec2(-0.3,  0.4);
//    L[4] = glm::vec2(0.5,  -0.3);
//    L[5] = glm::vec2(0.4,  -0.7);
//    L[6] = glm::vec2(0.8,  -0.8);
//    L[7] = glm::vec2(0.1,  -0.1);
//    L.resize(1);
    L.push_back(glm::vec2(0,  0));
//    L[1] = glm::vec2(-0.6,  0.8);
//    L[2] = glm::vec2(-0.8,  0.3);
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        int ver_num = L.size() - 1;

        int tri_num = ver_num / 3;
        int dot_num = ver_num - tri_num * 3;

        //glDrawArrays(GL_TRIANGLES, 1, tri_num * 3);
...
//        if (dot_num > 2)
//        {
//            glDrawArrays(GL_LINE_STRIP, tri_num * 3 + 1, ver_num);
//        }
